                ...
                slivers: <Widget>[
                 SliverPersistentHeader(
                  ...
                  // BannerShimmerWidget(),
                      InkWell(
                        onTap: (){
                          if(setting.value.fbRdLink=='discount_upto') {
                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) {
                              return  ShopAllList(pageTitle: S.of(context).discount, type: 'discount_upto',coverImage: 'assets/img/cover3.jpg',para: setting.value.fbPara,);
                            }));
                          }
                      ...
                      const SizedBox(height:10),
                      _con.featuredProductList.isNotEmpty?Container(
                        padding: const EdgeInsets.symmetric(horizontal: 20),
                        child:Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children:[
                              Expanded(
                                child:Text(S.of(context).featured_products,
                                    style: Theme.of(context).textTheme.displayMedium
                                ),
                              ),
                            ]
                      ...
                      const SizedBox(height:10),
                      _con.popularProductList.isNotEmpty? Container(
                        padding: const EdgeInsets.symmetric(horizontal: 20),
                        child:Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children:[
                     ...
                     const SliderShopWidget(),
                      ...
                      const SizedBox(height:10),
                      RecommendShop(vendorList: _con.vendorRecommendList,),

                ...
                child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(color: Theme.of(context).primaryColorDark.withOpacity(0.13), borderRadius: BorderRadius.circular(10)),
                      ...
                      Container(
                          ...
                          child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: Theme.of(context).textTheme.bodyMedium.merge(const TextStyle(color: Colors.grey)),
                      ...
                      Container(
                          ...
                          child: Text(
                            'DIRECTIONS TO REACH',
                            style: Theme.of(context).textTheme.bodyMedium.merge(const TextStyle(color: Colors.grey)),
                          )),
                      Container(
                        margin: const EdgeInsets.only(left: 10, right: 10),
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration.collapsed(
                              ...
                              hintStyle: Theme.of(context).textTheme.bodyMedium.merge(const TextStyle(color: Colors.grey)),
                            ),
                          ),
                        ),
                      ),
            ...
            Align(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(backgroundColor: MaterialStateProperty.all(transparent), elevation: MaterialStateProperty.all(0), shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(7)))),
                  onPressed: () {
                  ...
                  child: Container(
                    ...
                    child: Text('Submit', style: Theme.of(context).textTheme.titleLarge.merge(TextStyle(color: Theme.of(context).colorScheme.primary, height: 1.1))),
                  ),
                ),
              ),
            ),

        ...
        builder: (context, setting1, _) {
          return currentCart.value.isNotEmpty
              ? Container(
                  ...
                  decoration: BoxDecoration(color: customeColor1, borderRadius: BorderRadius.circular(18)),
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              RichText(
                                text: TextSpan(text: ' ${currentCart.value.length} ${S.of(context).item} | ', style: Theme.of(context).textTheme.titleLarge.merge(TextStyle(color: Theme.of(context).primaryColorLight)), children: [TextSpan(text: '${Helper.pricePrint(_con.calculateAmount())}', style: Theme.of(context).textTheme.titleLarge.merge(TextStyle(color: Theme.of(context).primaryColorLight)))]),
                              ),
                              Text(
                                'From ${setting.value.appName}',
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          shape: RoundedRectangleBorder(side: BorderSide(color: transparent, width: 1, style: BorderStyle.solid), borderRadius: BorderRadius.circular(50)),

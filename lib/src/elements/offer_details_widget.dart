      ...
      Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              child: Text(S.of(context).available_coupons, style: Theme.of(context).textTheme.titleMedium),
            ),
            ListView.separated(
              ...
              itemBuilder: (context, int index) {
                ...
                return Container(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(image: const DecorationImage(image: AssetImage('assets/img/coupon_card7.png'), fit: BoxFit.fill), borderRadius: BorderRadius.circular(15.0), boxShadow: const [
                          BoxShadow(
                            ...
                            child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    (widget.pageType != 'vendor' && double.parse(coupon.minimumPurchasedAmount) <= currentCheckout.value.sub_total)
                                        ? InkWell(
                                            onTap: () {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Wrap(
                                        children: [
                                          coupon.couponType != '4' ? Container(padding: const EdgeInsets.only(top: 8, right: 5), child: Text(coupon.discountType == '%' ? '%' : '${setting.value.defaultCurrency} OFF', style: Theme.of(context).textTheme.bodySmall)) : Container(padding: const EdgeInsets.only(top: 8, right: 5), child: Text(S.of(context).free_delivery, style: Theme.of(context).textTheme.bodySmall)),
                                          Text(
                                            coupon.discount,
                                            style: Theme.of(context).textTheme.headlineLarge,
                                          ),
                                          Container(padding: const EdgeInsets.only(top: 10, left: 5), child: Text('COUPON', style: Theme.of(context).textTheme.bodySmall)),
                                        ],
                                      ),
                                    ),
                                    Container(
...
class TermsPopupHelper {
  static exit(context, content) => showDialog(
      context: context,
